...
ALTER TABLE public.film_genre ALTER COLUMN genre_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: zip_code_info; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.zip_code_info (
...
ALTER TABLE public.zip_code_info OWNER TO postgres;
...
--
-- Name: film_genre genre_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: zip_code_info zip_code_info_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.zip_code_info
...
--
-- Name: payment_rental_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX payment_rental_id_idx ON public.payment USING btree (rental_id);


--
-- Name: rental_rental_period_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX rental_rental_period_idx ON public.rental USING gist (rental_period);
...
CREATE INDEX us_postal_code_geog_gix ON public.zip_code_info USING gist (geog);
...
ALTER TABLE ONLY public.customer
    ADD CONSTRAINT customer_store_id_fkey FOREIGN KEY (store_id) REFERENCES public.store(store_id) ON DELETE SET NULL;


--
-- Name: customer customer_zip_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.customer
    ADD CONSTRAINT customer_zip_code_fkey FOREIGN KEY (zip_code) REFERENCES public.zip_code_info(zip_code);
...
--
-- Name: film_production_company film_production_company_film_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.film_production_company
    ADD CONSTRAINT film_production_company_film_id_fkey FOREIGN KEY (film_id) REFERENCES public.film(film_id) ON DELETE CASCADE;


--
-- Name: film_production_company film_production_company_production_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.film_production_company
    ADD CONSTRAINT film_production_company_production_company_id_fkey FOREIGN KEY (production_company_id) REFERENCES public.production_company(production_company_id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.inventory
    ADD CONSTRAINT inventory_film_id_fkey FOREIGN KEY (film_id) REFERENCES public.film(film_id) ON DELETE RESTRICT;


--
-- Name: inventory inventory_store_id_fkkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inventory
    ADD CONSTRAINT inventory_store_id_fkkey FOREIGN KEY (store_id) REFERENCES public.store(store_id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.payment
    ADD CONSTRAINT payment_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customer(customer_id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.rental
    ADD CONSTRAINT rental_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customer(customer_id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.rental
    ADD CONSTRAINT rental_inventory_id_fkey FOREIGN KEY (inventory_id) REFERENCES public.inventory(inventory_id) ON DELETE RESTRICT;


--
-- Name: store store_zip_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.store
    ADD CONSTRAINT store_zip_code_fkey FOREIGN KEY (zip_code) REFERENCES public.zip_code_info(zip_code);
